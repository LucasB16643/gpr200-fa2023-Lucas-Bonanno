...
int main() {
	...
	ew::MeshData sphereMeshData = lLib::createSphere(0.5f, 16);
	ew::MeshData cylinderMeshData = lLib::createCylinder(1.0f, 0.5f, 16);
	ew::MeshData planeMeshData = lLib::createPlane(0.5f, 10);
	//Create cube
